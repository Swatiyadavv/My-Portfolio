...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_t8klbe2', // Replace with your EmailJS service ID
        'template_db4haft', // Replace with your EmailJS template ID
        {
          from_name: form.name,
          from_email: form.email,
          message: form.message,
        },
        'jOXUQDMllDck2jTcS' // Replace with your EmailJS user ID
      )
      .then(
        () => {
          setLoading(false);
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a
              href="mailto:swatiyadav66145@gmail.com"
              target="_blank"
              className="blue-text-gradient"
            >
              swatiyadav66145@gmail.com
            </a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
